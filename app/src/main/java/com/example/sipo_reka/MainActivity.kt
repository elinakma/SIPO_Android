...
fun AppNavigator(navController: NavHostController) {
    NavHost(
        ...
        composable("kirimUndanganAdmin") { KirimUndanganAdmin(navController) }
        // Risalah
        composable("risalahAdmin") { RisalahAdmin(navController) }
        composable("detailRisalahAdmin") { DetailRisalahAdmin(navController) }
        composable("kirimRisalahAdmin") { KirimRisalahAdmin(navController) }
